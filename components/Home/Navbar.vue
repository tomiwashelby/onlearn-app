<template>
	<nav class="px-24 h-28 flex items-center justify-between text-color-pri mx-auto">
		<NuxtLink to="/">
		...
		<ul class="flex gap-8">
			<li v-for="(item, i) in cta" :key="i" class="cursor-pointer px-8 font-semibold py-3 rounded-md hover:scale-[0.95] duration-200" :class="[item.bgColor, item.color]">
